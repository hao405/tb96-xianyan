...
def objective(trial):
    ...
    args.zd_kl_weight = trial.suggest_float('zd_kl_weight', 1e-25, 1e-15, log=True)
    args.zc_kl_weight = trial.suggest_float('zc_kl_weight', 1e-25, 1e-15, log=True)
    args.hmm_weight = trial.suggest_float('hmm_weight', 1e-20, 1e-14, log=True)
    ...
    args.alpha = trial.suggest_float('alpha', 0.31, 0.4, log=True)
