...
def objective(trial):
    ...
    args.zd_kl_weight = trial.suggest_float('zd_kl_weight', 1e-40, 1e-20, log=True)
    args.zc_kl_weight = trial.suggest_float('zc_kl_weight', 1e-40, 1e-20, log=True)
    args.hmm_weight = trial.suggest_float('hmm_weight', 1e-40, 1e-20, log=True)
    args.rec_weight = trial.suggest_float('rec_weight', 1e-40, 1e-20, log=True)
